...
class ReportsWidget extends StatefulWidget {
  ...
  const ReportsWidget({super.key, required this.teacher});
...
class _ReportsWidgetState extends State<ReportsWidget> {
  ...
  Future<void> _generateReport() async {
    ...
    try {
      ...
      if (fileService.isWeb) {
        showSuccessSnackBar(context, 'Report generated and downloaded');
      } else {
  ...
  Future<void> _generateLowAttendanceReport() async {
    ...
    try {
      ...
      if (fileService.isWeb) {
        showSuccessSnackBar(context, 'Low attendance report generated and downloaded');
      } else {
